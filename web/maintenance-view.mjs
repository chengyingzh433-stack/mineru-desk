...
function render(slot){
 ...
 slot.innerHTML=`<div class="toolbar"><h2>版本与维护</h2><span class="badge">v${escape(info?.version||'0.3.2')}</span></div>
...
export async function maintenanceAction(action){
 ...
 if(!['check','download','cancel','install','uninstall'].includes(action))return;
 if(window.__mineruUnsaved?.())throw Error('请先保存或放弃正在编辑的内容和设置');
